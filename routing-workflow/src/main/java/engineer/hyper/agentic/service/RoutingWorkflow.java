...
import engineer.hyper.agentic.dto.RoutingResponse;
...
public class RoutingWorkflow {
    ...
    public List<String> start(List<String> tickets, Map<String, String> supportRoutes) {
        return tickets.stream()
                .map(ticket -> route(ticket, supportRoutes))
                .toList();
    }
